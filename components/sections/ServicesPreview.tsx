    ...
    <section className='py-12 sm:py-16 md:py-20 lg:py-24 bg-muted/30'>
      <div className='container px-4 sm:px-6'>
        <div className='mx-auto max-w-2xl text-center mb-10 sm:mb-12 lg:mb-16'>
          ...
          <p className='mt-3 sm:mt-4 text-base sm:text-lg text-muted-foreground'>{SECTIONS.SERVICES.SUBTITLE}</p>
        </div>

        <div className='grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-10 sm:mb-12'>
