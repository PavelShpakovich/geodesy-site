          ...
          {!state.success && state.message && (
            <div className='p-3 sm:p-4 rounded-lg bg-red-50 border border-red-200 flex items-start gap-2 sm:gap-3'>
              ...
              <div className='flex-1 flex flex-col gap-1'>
                <p className='text-xs sm:text-sm font-medium text-red-800'>{state.message}</p>
                {state.errors && state.errors.length > 0 && (
                  <ul className='text-xs sm:text-sm text-red-700 list-disc list-inside flex flex-col gap-0.5'>
