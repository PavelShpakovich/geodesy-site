    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      {showText && (
        <div className='flex flex-col'>
          <span className='text-lg font-bold leading-none tracking-tight'>ГеоСервис</span>
          <span className='text-[10px] text-muted-foreground leading-none tracking-wide'>ГЕОДЕЗИЯ • БРЕСТ</span>
        </div>
      )}
    </div>
  );
...
/**
 * Alternative Simple Logo - Compass Rose
 */
export function LogoSimple({ className = '' }: { className?: string }) {
  return (
    <svg
      ...
      aria-label='Geodesy Logo'
    >
      {/* Compass Circle */}
      <circle cx='20' cy='20' r='16' stroke='currentColor' strokeWidth='2' className='text-primary' />

      {/* North Arrow */}
      <path d='M20 6L23 14L20 12L17 14L20 6Z' fill='currentColor' className='text-primary' />

      {/* South Point */}
      <path d='M20 34L17 26L20 28L23 26L20 34Z' fill='currentColor' className='text-primary' opacity='0.6' />
